...
//------------------------------------------------------------------------------
    // FUNCIONANDO, MAS NÃO DEFINITIVO
    public RespostaCompletaDTO buscarListaPorPalavraDoTitulo(JsonObject dados){
        ...
        try(Connection conexao = getConnection()){
            ...
            if(contains(keys,"titulo")){
                String[] palavrasDoTitulo = extrairPalavrasDaBusca(dados,"titulo");
            ...
            if(contains(keys,"autoria")){
                String[] palavrasDaAutoria = extrairPalavrasDaBusca(dados,"autoria");
            ...
            if(contains(keys,"veiculo")){
                String[] palavrasDoVeiculo = extrairPalavrasDaBusca(dados,"veiculo");
...
//------------------------------------------------------------------------------    
    private String prepararComandoSQL3(JsonObject dados){
        ...
        if(contains(keys,"titulo")&&
                (contains(keys,"autoria")||contains(keys,"veiculo"))){
...
//        if((contains(keys,"titulo")||contains(keys,"autoria"))&&
        if(contains(keys,"autoria") && contains(keys,"veiculo")){
            comando = comando + union;
        }
...
//------------------------------------------------------------------------------    
    private String[] extrairPalavrasDaBusca(JsonObject dados,String campo){
